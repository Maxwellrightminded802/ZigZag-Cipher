...
3. **Download the Windows Executable**  
   Under the "Assets" section of the latest release, find the file ending with `.exe`. It might have a name like `ZigZag-Cipher-win.exe` or similar. Click it to download.
